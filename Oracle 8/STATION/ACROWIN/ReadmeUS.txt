...
1. From the Windows Program Manager, choose Run from the File menu and type 

   [cd-rom drive]:acro_v2\acrowin\disk1\setup.exe 
  
2. Follow the instructions on your screen. Installation requires approximately 
